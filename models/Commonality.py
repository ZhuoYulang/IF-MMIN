...
class CommonalityModel(BaseModel):
    @staticmethod
    ...
    def backward(self):
        ...
        # print('utt_fusion_model.self.logits.size is:', self.logits.size())
        # print('utt_fusion_model.self.pred.size is:', self.pred.size())
        # print('utt_fusion_model.self.label.size is:', self.label.size())
        # print('utt_fusion_model.self.logits is:', self.logits)
        # print('utt_fusion_model.self.pred is:', self.pred)
        # print('utt_fusion_model.self.label is:', self.label)
        # print('self.logits.size is:', self.logits.size())
        # print('self.label.size is:', self.label.size())
